function [cm] = create_color_model_object(bead_file,blank_file,bead_model,bead_batch,translation_plot,noise_plot, fitc_channel_name,channel_mins,min_valid_count,pem_drop_threshold)
